...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'brand' => 'Марка',
        'price' => 'Цена',
        'image_upload1' => 'Картинка №1',
        'image_upload2' => 'Картинка №2',
        'image_upload3' => 'Картинка №3',
        'image_upload4' => 'Картинка №4',
        'image_upload5' => 'Картинка №5',
        'image_upload6' => 'Картинка №6',
        'image_upload7' => 'Картинка №7',
        'image_upload8' => 'Картинка №8',
        'geo_city' => 'Местоположение',
        'old_password' => 'Старый пароль',
        'partner_id' => 'Пригласивший',
        'amount' => 'Сумма'
    ],
];
