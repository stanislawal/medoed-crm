                ...
                <div class="row">
                    <div class="col-12 col-sm-6 col-lg-4 col-xl-3 mb-2">
                        <div class="px-3 py-2 shadow border bg-white rounded">
                            <div class="text-24">
                                <strong>{{ number_format($indicators['sum_plan_gross_income'] + 0, 2, '.', ' ') }} ₽</strong>
                            </div>
                            <div class="text-12 nowrap-dot">Итог план ВД:</div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-sm-6 col-lg-4 col-xl-3 mb-2">
                        <div class="px-3 py-2 shadow border bg-white rounded">
                            <div class="text-24">
                                <strong>{{ number_format($indicators['sum_gross_income'] + 0, 2, '.', ' ') }} ₽</strong>
                            </div>
                            <div class="text-12 nowrap-dot">Итог факт ВД:</div>
                        </div>
                    </div>
                </div>
            </div>
