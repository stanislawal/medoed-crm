                ...
                <div class="row m-0" id="search">
                    <div class="w-100 row m-0 py-3">
                        ...
                        <div class="form-group col-12 col-md-4 col-lg-3">
                            ...
                            <div class="input-group">
                                <input type="number" step="0.01" class="form-control form-control-sm"
                                    name="sum_without_space_from" value="{{ request()->sum_without_space_from ?? '' }}"
                                    placeholder="От">
                                <input type="number" step="0.01" class="form-control form-control-sm"
                        ...
                        <div class="form-group col-12 col-md-4 col-lg-3">
                            ...
                            <div class="input-group">
                                <input type="number" step="0.01" class="form-control form-control-sm"
                                    name="date_diff_from" value="{{ request()->date_diff_from ?? '' }}" placeholder="От">
                                <input type="number" step="0.01" class="form-control form-control-sm"
                        ...
                        <div class="form-group col-12 col-md-4 col-lg-3">
                            ...
                            <select class="form-control border form-control-sm select-2" title="Пожалуйста, выберите"
                                ...
                                @foreach ($clients as $client)
                                    <option @if ($client['id'] == request()->client_id) selected @endif value="{{ $client['id'] }}">
                                        {{ $client['name'] }}</option>
                                @endforeach
                            </select>
                        </div>
            ...
            <div class="row">
                <div class="col-12 col-md-9">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 col-xl-4 mb-2">
                            <div class="px-3 py-2 shadow border bg-white rounded">
                                <div class="text-24"><strong>{{ number_format($statistics['profit'], 2, '.', ' ') }}</strong>
                                </div>
