            ...
            <div class="shadow border rounded row mb-3">
                ...
                <div class="w-100 row m-0 p-2">
                    <div class="form-group col-12 col-lg-6">
                        ...
                        <input type="text" value="{{ $user['full_name'] ?? '-' }}"  class="form-control form-control-sm" name="full_name">
                    </div>
                    <div class="form-group col-12 col-lg-6">
                        <label for="" class="form-label">Логин</label>
                        <input type="text" value="{{ $user['login'] ?? '-' }}"  class="form-control form-control-sm" name="login">
                    </div>
                    <div class="form-group col-12 col-lg-6">
                    ...
                    <div class="form-group col-12 col-lg-6">
                        ...
                        <input type="text" value="{{$user['contact_info']}}"  class="form-control form-control-sm" name="contact_info">
                    </div>
                    <div class="form-group col-12 col-lg-6">
                    ...
                    <div class="form-group col-12 col-lg-6">
                        ...
                        <select class="form-select form-select-sm select-manager"  name="role" id="">
                            ...
                            <option value="Менеджер" @if(\App\Helpers\UserHelper::getRoleName($user['id']) == 'Менеджер') selected @endif>Менеджер</option>
                            <option value="Автор" @if(\App\Helpers\UserHelper::getRoleName($user['id']) == 'Автор') selected @endif>Автор</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group col-12 col-lg-6 input-manager">
                        ...
                        <input type="number" value="{{$user['manager_salary']}}" class="form-control form-control-sm" name="manager_salary">
                    </div>
