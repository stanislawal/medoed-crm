...
class NotificationTypeConstants
{
    ...
    public const WRITE_TO_CLIENT_WEEK = 'WRITE_TO_CLIENT_WEEK'; // написать клиенту, прошла неделя
    ...
    public const UPDATE_STATUS_LID = 'UPDATE_STATUS_LID'; // обновление статуса лида
}
